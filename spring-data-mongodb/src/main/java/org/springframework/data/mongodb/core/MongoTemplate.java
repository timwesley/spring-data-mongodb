...
public class MongoTemplate implements MongoOperations, ApplicationContextAware, IndexOperationsProvider {
	...
	public <T> GeoResults<T> geoNear(NearQuery near, Class<?> domainType, String collectionName, Class<T> returnType) {
		...
		String distanceField = computeDistanceFieldName(domainType);
	...
	private String computeDistanceFieldName(Class<?> domainType) {

		String distanceFieldName = "dis";
		if (!mappingContext.hasPersistentEntityFor(domainType)
				|| mappingContext.getPersistentEntity(domainType).getPersistentProperty(distanceFieldName) == null) {
			return distanceFieldName;
		}

		distanceFieldName = "calculated-distance";
		while (mappingContext.getPersistentEntity(domainType).getPersistentProperty(distanceFieldName) != null) {
